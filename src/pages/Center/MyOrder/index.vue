    ...
    <div class="order-right">
      <div class="order-content">
        ...
        <div class="orders">
          <table
            class="order-item"
            v-for="item in orderListInfo.records"
            :key="item.id"
          >
            <thead>
              <tr>
              ...
              >
                ...
                >
                  <ul class="unstyled">
                    ...
                    <li>
                      {{
                        item.paymentWay === "ONLINE" ? "线上支付" : "货到付款"
                      }}
                    </li>
                  </ul>
                </td>
...
export default {
  ...
  methods: {
    async getOrderListInfo(page = 1) {
         this.page = page
      const result = await this.$API.reqOrderListInfo(this.page, this.limit);
      if (result.code === 200) {
