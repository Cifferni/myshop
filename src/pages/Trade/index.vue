...
export default {
  ...
  computed: {
    ...
    ...mapState({
      userAddressInfo: (state) => state.user.userAddressInfo,
      tradeInfo:(state) => state.trade.tradeInfo
    }),
     defaultAddress(){
       //find会遍历数组,返回item符合条件的 item
